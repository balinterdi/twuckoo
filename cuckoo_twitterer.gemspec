...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["bin/cuckoo_twitterer", "CHANGELOG", "lib/cuckoo_twitterer.rb", "lib/duration_string.rb", "lib/environments.rb", "lib/modules/one_line_from_file.rb", "tasks/spec.rake"]
  s.files = ["bin/cuckoo_twitterer", "CHANGELOG", "cuckoo_twitterer.gemspec", "lib/cuckoo_twitterer.rb", "lib/duration_string.rb", "lib/environments.rb", "lib/modules/one_line_from_file.rb", "Manifest", "Rakefile", "spec/cuckoo_twitterer_spec.rb", "spec/duration_string_spec.rb", "spec/one_line_from_file_spec.rb", "spec/spec.opts", "tasks/spec.rake"]
